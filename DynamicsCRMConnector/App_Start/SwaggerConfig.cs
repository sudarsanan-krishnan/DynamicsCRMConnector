...
namespace DynamicsCRMConnector
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "DynamicsCRMConnector");
                        ...
                        //c.OperationFilter<DynamicCreateOpFilter>();
        ...
        public static void Register()
        {
            List<string> discoveryPath = new List<string>() { "swagger/docs/v1" };
            SwaggerEnabledConfiguration configuration = new SwaggerEnabledConfiguration(
            GlobalConfiguration.Configuration,
            JsonSwaggerGenerator.DefaultRootUrlResolver,
            discoveryPath);

            configuration.EnableSwaggerUi();
        }
