...
namespace Microsoft.Integration.Common.Messaging
{
    ...
    public class MessageDescription
    {
        ...
        public MessageDescription(string content, IDictionary<string, object> allProperties, string contentType)
        {
        ...
        /// <param name="allProperties"></param>
        /// <param name="contentType"></param>
        public MessageDescription(Stream stream, IDictionary<string, object> allProperties, string contentType)
        {
